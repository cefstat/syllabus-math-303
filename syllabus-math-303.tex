...
\newcommand{\KEActivity}[2]{{\bfseries #1} & \KEmc{4}{0.82}{#2}{\itshape}}
\newcommand{\KEActivityX}[3]{{\bfseries #1} & \KEmc{3}{0.67}{#2}{\itshape} & #3}
\setlength{\tabcolsep}{0pt}
...
\rowcolor{dku-blue} {\color{white}\bfseries Class meetings} & {\color{white}\color{white}\bfseries Class topic/unit name }  & {\color{white}\color{white}\bfseries Pre-class work for students}  & {\color{white}\color{white}\bfseries Planned in-class activities}  & {\color{white}\color{white}\bfseries Assignments\newline due} \\
\endhead 

\KEPart{Part 1 (Fundamentals)}

\#1 (Mon 23 Aug) & Course overview; what are differential equations and why are they useful?  & Read the syllabus \newline Watch \href{https://www.youtube.com/watch?v=p_di4Zn4wz4}{video} & Lecture; Discussion &  \\
\#2 (Tue 24 Aug) & Introduction to Mathematica; & Install Mathematica and watch the video & Lecture; Discussion & \\ 

\#3 (Wed 25 Aug) & Solutions and initial value problems (1.2); Direction fields (1.3); The approximation method of Euler (1.4); & Review reading guide for part 1 & Lecture; Discussion & \\

\KEPart{Part 2 (First-order differential equations)}

\#4 (Thu 26 Aug) & Separable equations (2.2); Linear equations (2.3); & Review reading guide for part 2  & Lecture; Discussion & \\

\#5 (Mon 30 Aug) & Applications; Substitutions and transformations (2.6); & & Lecture; Discussion &  \\

\#6 (Tue 31 Aug) & Existence and uniqueness of solutions (13.1, 13.2); &   & Lecture; Discussion &  \\
...
\KEPart{Part 3 (Linear differential equations)}
...
\#11 (Wed 8 Sep) & Higher order linear differential equations (6.1, 6.2); &  & Lecture; Discussion & Written report: Project Proposal \\

\KEPart{Part 4 (Systems and phase plane analysis)}

\#12 (Thu 9 Sep) & Introduction to the phase plane (5.4); & Review reading guide for part 4 & Lecture; Discussion &  Homework 2 \\

\rowcolor{yellow} \KEActivity{\#13 (Mon 13 Sep)}{\textbf{Midterm exam 1.} The first midterm exam will cover material taught until lecture 11.} \\
...
\\
\rowcolor{red} \KEmc{5}{1.0}{\ Mid-Autumn Festival}{\bfseries\color{white}} \\
\\

\KEPart{Part 6 (Planar autonomous systems)}
...
\#21 (Mon 27 Sep) & Energy methods (12.4); &  & Lecture; Discussion & \\

\#22 (Tue 28 Sep) & Lyapunov’s method (12.5); &  & Lecture; Discussion & Written report: Preliminary Research Results \\

\#23 (Wed 29 Sep) & Limit cycles and periodic solutions (12.6); &  & Lecture; Discussion & \\

\rowcolor{yellow} \KEActivityX{\#24 (Thu 30 Sep)}{\textbf{Practice presentations.} These will not be graded but you will receive feedback.}{Homework 5} \\

\\
\rowcolor{red} \KEmc{5}{1.0}{\ Chinese National Day Holiday}{\bfseries\color{white}} \\
\\

\rowcolor{yellow} \KEActivity{\#25 (Mon 11 Oct)}{\textbf{Midterm exam 2.} The second midterm exam will cover material taught until lecture 22.} \\


\KEPart{Part 7 (Bifurcation theory)}
...
\rowcolor{yellow} \KEActivity{Final Presentations}{Final presentations will take place in the final week. The exact date and time will be announced later. These will determine the grade for your project presentations.} \\

\KEPart{Exam week}

\KEActivity{Final Exam}{The date for the final exam is Wednesday, 20 October 2021, 15:30-18:30. The exam will take place in IB 1011.} \\
\KEActivity{Written Project Report}{The final version of the written report will be due on Thursday 21 October.} \\
