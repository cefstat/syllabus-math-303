...
\newcolumntype{a}{>{\columncolor{dku-blue!20!white}}l}
\newcolumntype{b}{>{\columncolor{dku-blue!10!white}}l}
\newcommand{\bw}{\color{white}\bfseries}
\begin{center}
\begin{tabular}[t]{abababab}
\rowcolor{dku-blue} 
\bw Grade & \bw Percentage (p) &
\bw Grade & \bw Percentage (p) &
\bw Grade & \bw Percentage (p) &
\bw Grade & \bw Percentage (p) \\
D+ & 67\% ≤ p < 70\% &
...
\\
\rowcolor{red} \KEmc{5}{1.0}{\ 春节 (Spring Festival)}{\bfseries\color{white}} \\
\\


\rowcolor{yellow} \KEActivity{\#13 (Mon 7 Feb)}{\textbf{Midterm exam 1.} The first midterm exam will cover material taught until lecture 11.} \\
...
\rowcolor{yellow} \KEActivityX{\#24 (Thu 24 Feb)}{\textbf{Practice presentations.} These will not be graded but you will receive feedback.}{Homework 5} \\

%\\
%\rowcolor{red} \KEmc{5}{1.0}{\ Chinese National Day Holiday}{\bfseries\color{white}} \\
%\\

\rowcolor{yellow} \KEActivity{\#25 (Mon 28 Feb)}{\textbf{Midterm exam 2.} The second midterm exam will cover material taught until lecture 22.} \\
...
\rowcolor{yellow} \KEActivity{Final Presentations}{Final presentations will take place in the final week. The exact date and time will be announced later through Teams. These will determine the grade for your project presentations.} \\

\KEPart{Exam week}

\KEActivity{Final Exam}{The date and place for the final exam will be announced later. } \\
\KEActivity{Written Project Report}{The final version of the written report will be due sometime during the exam week. The exact date will be announced later.} \\
